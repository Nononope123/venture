          ...
          <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex-shrink-0 flex items-center">
              <Image
                ...
                height={32}
              />
              <span className="ml-2 text-xl font-bold text-gray-800">K-Venture</span>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-6">
                      <div>
                        ...
                        <ul className="space-y-3">
                          <li><a href="#" className="text-gray-600 hover:text-indigo-600">Histoire</a></li>
                      ...
                      <div>
                        ...
                        <ul className="space-y-3">
                          <li><a href="#" className="text-gray-600 hover:text-indigo-600">Biographie</a></li>
                          <li><a href="#" className="text-gray-600 hover:text-indigo-600">Parcours professionnel</a></li>
                          <li><a href="#" className="text-gray-600 hover:text-indigo-600">Impact & ambitions</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
          ...
          <div className="relative">
            ...
            <div className={`${isMobileAboutDropdownOpen ? 'block' : 'hidden'} px-4 py-2`}>
              ...
              <div className="border-l-2 border-indigo-500 pl-2">
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-indigo-600 block">Biographie</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-indigo-600 block">Parcours professionnel</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-indigo-600 block">Impact & ambitions</a></li>
                </ul>
              </div>
            </div>
          </div>
