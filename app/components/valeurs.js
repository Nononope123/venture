...
function Valeurs() {
  return (
      <motion.div
        className="bg-cover md:w-[80%] justify-start rounded-md bg-center p-5"
        style={{
        ...
        >
          ...
          >
            <h1 className="text-white font-bold text-3xl mb-5">
              Notre Vision : Transformer les Dirigeants et les Organisations
            </h1>
            <h1 className="text-white text-base text-justify">
            Nous avons pour ambition de faire émerger des leaders transformationnels, capables de guider leurs
            équipes et leurs entreprises vers plus de cohérence, de performance et de croissance durable.
            </h1>
          </motion.div>
          <motion.div
