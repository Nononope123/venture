          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="relative rounded-2xl bg-gray-50 p-8 shadow-lg">
              <div className="flex items-center gap-4">
                ...
                <h3 className="mt-0 text-lg font-semibold text-gray-900">Leaders Transformationnels</h3>
              </div>
            ...
            <div className="relative rounded-2xl bg-gray-50 p-8 shadow-lg">
              <div className="flex items-center gap-4">
                ...
                <h3 className="mt-0 text-lg font-semibold text-gray-900">Développement Individuel</h3>
              </div>
            ...
            <div className="relative rounded-2xl bg-gray-50 p-8 shadow-lg">
              <div className="flex items-center gap-4">
                ...
                <h3 className="mt-0 text-lg font-semibold text-gray-900">Transformation Organisationnelle</h3>
              </div>
